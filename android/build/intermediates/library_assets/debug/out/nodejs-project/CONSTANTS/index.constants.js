module.exports = {
  ...
  axios: () => {
    return (function(global, factory) {
      ...
      var predicates = utils.toFlatObject(utils, {}, null, function filter(
        prop,
      ) {
      ...
      utils.forEach(['delete', 'get', 'head', 'post', 'put', 'patch'], function(
        method,
      ) {
              ...
              value: function has(header, matcher) {
                ...
                if (header) {
                  ...
                  return !!(
                    ...
                    this[key] !== undefined &&
                    (!matcher ||
                      matchHeaderValue(this, this[key], key, matcher))
                  );
                }
                return false;
              },
      ...
      var xhrAdapter =
        ...
        function(config) {
          return new Promise(function dispatchXhrRequest(resolve, reject) {
            ...
            var requestHeaders = AxiosHeaders$1.from(
              config.headers,
            ).normalize();
            ...
            if ('setRequestHeader' in request) {
              utils.forEach(requestHeaders.toJSON(), function setRequestHeader(
                val,
                key,
              ) {
